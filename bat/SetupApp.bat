...
set CERT_NAME="Starling-builder-editor"
set CERT_PASS=fd
set CERT_FILE="bat\Starling-builder-editor.p12"
set SIGNING_OPTIONS=-storetype pkcs12 -keystore %CERT_FILE% -storepass %CERT_PASS%

:: Application descriptor
set APP_XML=src\starlingbuilder\editor\Main-app.xml
...
:: Output
set AIR_PATH=air
set AIR_NAME=Starling-builder-editor
