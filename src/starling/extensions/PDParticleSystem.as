...
package starling.extensions
{
    ...
    public class PDParticleSystem extends ParticleSystem
    {
		...
		public function get startARGB():uint{ return startColor.toArgb()};
		public function set startARGB(value:uint):void { startColor = ColorArgb.fromArgb(value); };
		
		public function get startRGB():uint { return startColor.toRgb()};
		public function set startRGB(value:uint):void { startColor.fromRgb(value); };
		
		public function get startAlpha():Number { return startColor.alpha; };
		public function set startAlpha(value:Number):void { startColor.alpha = value; };
		...
		public function get endARGB():uint{ return endColor.toArgb()};
		public function set endARGB(value:uint):void { endColor = ColorArgb.fromArgb(value); };
		
		public function get endRGB():uint { return endColor.toRgb()};
		public function set endRGB(value:uint):void { endColor.fromRgb(value); };
		
		public function get endAlpha():uint { return endColor.alpha; };
		public function set endAlpha(value:uint):void { endColor.alpha = value; };
